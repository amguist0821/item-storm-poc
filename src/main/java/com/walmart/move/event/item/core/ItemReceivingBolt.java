 ...
 *
 */
public class ItemReceivingBolt extends BaseBasicBolt {
	...
	public void execute(Tuple input, BasicOutputCollector collector) {
		...
		if( !eventOrigin.equals(MASTER_ORIGIN)) {
			logger.info("Process is needing to update the format of the current pay load in order to meet the needs of the Receiving Product ....");
